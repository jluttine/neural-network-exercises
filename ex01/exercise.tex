...
\item
  ...
  \begin{solution}
    ...
    \begin{tikzpicture}[start chain=hidden going below,
      ...
      \draw[<-] (in5) -- ++(-1,0) node[label=left:$u_{1,n}$] {};
      \draw[<-] (in6) -- ++(-1,0) node[label=left:$u_{2,n}$] {};
      
      % % Input layer
      % \node[rectangle,draw=black] (in1) {};
      % \node[rectangle,draw=black,below=30pt of in1] (in2) {};
      % \node[rectangle,draw=black,below=30pt of in2] (in3) {};
      % \node[rectangle,draw=black,below=30pt of in3] (in4) {};
      % \node[rectangle,draw=black,below=30pt of in4] (in5) {};
      % \node[rectangle,draw=black,below=30pt of in5] (in6) {};
    \end{tikzpicture}
  \end{solution}
