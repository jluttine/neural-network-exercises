...
\item
  ...
  \begin{solution}
    ...
    \item \emph{Inaccurate simple explanation:} The whitening is not
      unique, because the result of the algorithm depends on initial
      set of linearly independent vectors which can be chosen
      arbitrarily.
      ...
      resulting set of whitened vectors is different. get usually a
      different whitening solution because there exists another set of
      linearly independent vectors. Thus whitening is by no means
      unique.
